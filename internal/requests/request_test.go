...
func TestRequestLineParse(t *testing.T) {
	...
	assert.Equal(t, "/abc", r.RequestLine.RequestTarget)
	assert.Equal(t, "1.1", r.RequestLine.HttpVersion)

	// Test: Invalid Method, Out of order request line
	reader = &chunkReader{
		data:            "/abc GET HTTP/1.1\r\nHost: localhost:42069\r\nUser-Agent: curl/7.81.0\r\nAccept: */*\r\n\r\n",
		numBytesPerRead: 3,
	}
	r, err = RequestFromReader(reader)
	require.Error(t, err)
	...
	// Test: Invalid HTTP Protocol Version
	reader = &chunkReader{
		data:            "GET / HTTP/1.2\r\nHost: localhost:42069\r\nUser-Agent: curl/7.81.0\r\nAccept: */*\r\n\r\n",
		numBytesPerRead: 3,
	}
...
func TestRequestBody(t *testing.T) {
	...
	// TODO: Test: Body bigger than content-length
	reader = &chunkReader{
		data: "POST /submit HTTP/1.1\r\n" +
			"Host: localhost:42069\r\n" +
			"Content-Length: 3\r\n\r\n" +
